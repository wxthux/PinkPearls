      ...
      <div className="container px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-orange-500">Elantré</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                ...
                <Link href="/admin/login" className="text-muted-foreground hover:text-orange-500 transition-colors">
                  Admin
                </Link>
              </li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-muted-foreground">info@Elantré.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t mt-8 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            © 2025 <span className="font-medium text-foreground">Elantré</span> 💎 Less is more, perfected
          </p>
